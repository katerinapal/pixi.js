...
exports.CanvasGraphicsRenderer = undefined;
...
_CanvasRenderer.CanvasRenderer.registerPlugin('graphics', CanvasGraphicsRenderer);
...
CanvasGraphicsRenderer.prototype.render = function (graphics) {
    ...
    for (var i = 0; i < graphics.graphicsData.length; i++) {
        ...
        } else if (data.type === _const.CONST.SHAPES.RECT) {
        ...
        } else if (data.type === _const.CONST.SHAPES.CIRC) {
        ...
        } else if (data.type === _const.CONST.SHAPES.ELIP) {
 ...
 * @param renderer {PIXI.SystemRenderer} The current PIXI renderer.
 */
exports.CanvasGraphicsRenderer = mod_CanvasGraphicsRenderer;