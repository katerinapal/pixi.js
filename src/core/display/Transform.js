...
function Transform() {
    ...
    * @member {PIXI.Point}
    */
    this.position = new _math.indexjs.Point(0, 0);
     ...
     * @member {PIXI.Point}
     */
    this.scale = new _math.indexjs.Point(1, 1);
     ...
     * @member {PIXI.Point}
     */
    this.pivot = new _math.indexjs.Point(0, 0);
...
Transform.prototype = Object.create(_TransformBase.TransformBase.prototype);
