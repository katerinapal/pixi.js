...
exports.TransformStatic = undefined;

var _math = require("../math");

var _TransformBase = require("./TransformBase");

function TransformStatic() {
    _TransformBase.TransformBase.call(this);
    /**
    * The coordinate of the object relative to the local coordinates of the parent.
    *
    * @member {PIXI.ObservablePoint}
    */
    this.position = new _math.indexjs.ObservablePoint(this.onChange, this, 0, 0);
     ...
     * @member {PIXI.ObservablePoint}
     */
    this.scale = new _math.indexjs.ObservablePoint(this.onChange, this, 1, 1);
     ...
     * @member {PIXI.ObservablePoint}
     */
    this.pivot = new _math.indexjs.ObservablePoint(this.onChange, this, 0, 0);
     ...
     * @member {PIXI.ObservablePoint}
     */
    this.skew = new _math.indexjs.ObservablePoint(this.updateSkew, this, 0, 0);
...
TransformStatic.prototype = Object.create(_TransformBase.TransformBase.prototype);
 ...
 * @memberof PIXI
 */
exports.TransformStatic = exported_TransformStatic;
