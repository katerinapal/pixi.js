...
exports.CanvasTinter = undefined;
...
var CanvasTinter = {
        ...
        tintWithPerPixel: function tintWithPerPixel(texture, color, canvas) {
                ...
                var rgbValues = _utils.utils.hex2rgb(color);
                var r = rgbValues[0],
                    g = rgbValues[1],
                    b = rgbValues[2];
        ...
        roundColor: function roundColor(color) {
                ...
                return _utils.utils.rgb2hex(rgbValues);
        },
         ...
         * @type {boolean}
         */
        canUseMultiply: (0, _canUseNewCanvasBlendModes.canUseNewCanvasBlendModes)(),
 ...
 * @param canvas {HTMLCanvasElement} the current canvas
 */
exports.CanvasTinter = mod_CanvasTinter = CanvasTinter;
exports.CanvasTinter = mod_CanvasTinter;