...
Texture.prototype.destroy = function (destroyBase) {
    if (this.baseTexture) {
        ...
        if (destroyBase) {
            ...
            if (_utils.utils.TextureCache[this.baseTexture.imageUrl]) {
                delete _utils.utils.TextureCache[this.baseTexture.imageUrl];
            }
...
Texture.fromImage = function (imageUrl, crossorigin, scaleMode) {
    var texture = _utils.utils.TextureCache[imageUrl];

    if (!texture) {
        texture = new Texture(_BaseTexture.BaseTexture.fromImage(imageUrl, crossorigin, scaleMode));
        _utils.utils.TextureCache[imageUrl] = texture;
    }
...
Texture.fromFrame = function (frameId) {
    var texture = _utils.utils.TextureCache[frameId];
...
Texture.from = function (source) {
    ...
    if (typeof source === 'string') {
        var texture = _utils.utils.TextureCache[source];
...
Texture.addTextureToCache = function (texture, id) {
    _utils.utils.TextureCache[id] = texture;
};
...
Texture.removeTextureFromCache = function (id) {
    var texture = _utils.utils.TextureCache[id];

    delete _utils.utils.TextureCache[id];
    delete _utils.utils.BaseTextureCache[id];
