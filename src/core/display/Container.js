 ...
 */
function Container() {
    _DisplayObject.DisplayObject.call(this);
...
// constructor
Container.prototype = Object.create(_DisplayObject.DisplayObject.prototype);
...
Container.prototype.setChildIndex = function (child, index) {
    ...
    _utils.utils.removeItems(this.children, currentIndex, 1); // remove from old position
...
Container.prototype.removeChild = function (child) {
    ...
    if (argumentsLength > 1) {
        ...
        child.parent = null;
        _utils.utils.removeItems(this.children, index, 1);
...
Container.prototype.destroy = function (options) {
    _DisplayObject.DisplayObject.prototype.destroy.call(this);
 ...
 * @memberof PIXI
 */
exports.Container = mod_Container;