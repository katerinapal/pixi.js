...
function SpriteRenderer(renderer) {
     ...
     * @member {number}
     */
    this.size = _const.CONST.SPRITE_BATCH_SIZE; // 2000 is a nice balance between mobile / desktop
...
SpriteRenderer.prototype.onContextChange = function () {
    ...
    this.MAX_TEXTURES = Math.min(gl.getParameter(gl.MAX_TEXTURE_IMAGE_UNITS), _const.CONST.SPRITE_MAX_TEXTURES);
 ...
 * @param renderer {PIXI.WebGLRenderer} The renderer this sprite batch works for.
 */
exports.SpriteRenderer = mod_SpriteRenderer;