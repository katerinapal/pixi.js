...
function Filter(vertexSrc, fragmentSrc, uniforms) {
     ...
     * @member {string}
     */
    Filter_vertexSrc = vertexSrc || Filter_defaultVertexSrc;;
     ...
     * @member {string}
     */
    Filter_fragmentSrc = fragmentSrc || Filter_defaultFragmentSrc;;
    ...
    this.glShaderKey = SOURCE_KEY_MAP[Filter_vertexSrc + Filter_fragmentSrc];
