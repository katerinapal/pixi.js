...
Sprite.prototype._onTextureUpdate = function () {
    ...
    if (this._width) {
        this.scale.x = _utils.utils.sign(this.scale.x) * this._width / this.texture.orig.width;
    }

    if (this._height) {
        this.scale.y = _utils.utils.sign(this.scale.y) * this._height / this.texture.orig.height;
    }
};
